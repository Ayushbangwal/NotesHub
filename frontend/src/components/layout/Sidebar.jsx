  ...
  return (
    <>
      ...
      <motion.aside
        initial={{ x: -300 }}
        animate={{ x: 0 }}
        className="fixed left-0 top-16 z-20 hidden lg:flex h-[calc(100vh-4rem)] w-64 flex-col border-r border-dark-border bg-dark-secondary"
      >
        <div className="flex-1 overflow-y-auto py-6">
          ...
          {isAuthenticated && user && (
            <div className="mt-auto px-3 py-6 border-t border-dark-border">
